...
REQUIRED_JARS = [
    ...
    "file:///opt/flink/kafka-clients-3.2.3.jar",
...
class KafkaConfig:
    connector: str = 'kafka'
    bootstrap_servers: str = 'insert bootstrap server config'
    scan_stratup_mode: str = 'earliest-offset'
    consumer_group_id: str = 'flink-consumer-group-1'
    security_protocol: str = 'SASL_SSL'
    sasl_mechanism: str = 'PLAIN'
    sasl_jaas_config: str = 'org.apache.kafka.common.security.plain.PlainLoginModule required username="enter Cluster API Key" password="Insert Cluster API Secret";'
